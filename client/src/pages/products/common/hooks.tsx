...
export function useProductColumns() {
    ...
    const columns: DataTableColumnsExtended<Product, ProductColumns> = [
        ...
        },
        {
            ...
            format: (value) => (
                <Tooltip
                    width="auto"
                    tooltipElement={
                        <div className="w-full overflow-auto break-all whitespace-normal max-h-48">
                            <article
        ...
        },
        {
            ...
            label: firstCustom,
            format: (value) =>
                formatCustomFieldValue('product1', value?.toString()),
        },
        {
            column: secondCustom,
            id: 'custom_value2',
            label: secondCustom,
            format: (value) =>
                formatCustomFieldValue('product2', value?.toString()),
        },
        {
            column: thirdCustom,
            id: 'custom_value3',
            label: thirdCustom,
            format: (value) =>
                formatCustomFieldValue('product3', value?.toString()),
        },
        {
            column: fourthCustom,
            id: 'custom_value4',
            label: fourthCustom,
            format: (value) =>
                formatCustomFieldValue('product4', value?.toString()),
        },
        {
            column: 'documents',
            id: 'documents',
    ...
    const actions = [
        ...
        (product: Product) =>
            ...
            isEditPage && (
                <DropdownElement
                    onClick={() =>
                        handleResourcefulAction('archive', product.id)
                    }
        ...
        (product: Product) =>
            ...
            isEditPage && (
                <DropdownElement
                    onClick={() =>
                        handleResourcefulAction('restore', product.id)
                    }
        ...
        (product: Product) =>
            ...
            isEditPage && (
                <DropdownElement
                    onClick={() =>
                        handleResourcefulAction('delete', product.id)
                    }
