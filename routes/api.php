...
Route::group(['middleware' => ['throttle:api', 'api_db', 'token_auth', 'locale'], 'prefix' => 'api/v1', 'as' => 'api.'], function () {
    ...
    Route::get('/fo-odcs/{id}', [FoOdcController::class, 'show']);
    Route::put('/fo-odcs/{id}', [FoOdcController::class, 'update']);
    Route::patch('/fo-odcs/{id}', [FoOdcController::class, 'update']);
    Route::delete('/fo-odcs/{id}', [FoOdcController::class, 'destroy']);
    Route::patch('/fo-odcs/{id}/archive', [FoOdcController::class, 'archive']);
    Route::patch('/fo-odcs/{id}/unarchive', [FoOdcController::class, 'unarchive']);
    Route::patch('/fo-odcs/{id}/restore', [FoOdcController::class, 'restore']);
    Route::post('/fo-odcs/bulk', [FoOdcController::class, 'bulk']);

    Route::get('/fo-kabel-odcs', [FoKabelOdcController::class, 'index']);
    Route::post('/fo-kabel-odcs', [FoKabelOdcController::class, 'store']);
    Route::get('/fo-kabel-odcs/{id}', [FoKabelOdcController::class, 'show']);
    Route::put('/fo-kabel-odcs/{id}', [FoKabelOdcController::class, 'update']);
    Route::patch('/fo-kabel-odcs/{id}', [FoKabelOdcController::class, 'update']);
    Route::delete('/fo-kabel-odcs/{id}', [FoKabelOdcController::class, 'destroy']);
    Route::patch('/fo-kabel-odcs/{id}/archive', [FoKabelOdcController::class, 'archive']);
    Route::patch('/fo-kabel-odcs/{id}/unarchive', [FoKabelOdcController::class, 'unarchive']);
    Route::patch('/fo-kabel-odcs/{id}/restore', [FoKabelOdcController::class, 'restore']);
    Route::post('/fo-kabel-odcs/bulk', [FoKabelOdcController::class, 'bulk']);
    ...
    Route::patch('/fo-kabel-core-odcs/{id}', [FoKabelCoreOdcController::class, 'update']);
    Route::delete('/fo-kabel-core-odcs/{id}', [FoKabelCoreOdcController::class, 'destroy']);
    Route::patch('/fo-kabel-core-odcs/{id}/archive', [FoKabelCoreOdcController::class, 'archive']);
    Route::patch('/fo-kabel-core-odcs/{id}/unarchive', [FoKabelCoreOdcController::class, 'unarchive']);
    Route::patch('/fo-kabel-core-odcs/{id}/restore', [FoKabelCoreOdcController::class, 'restore']);
    Route::post('/fo-kabel-core-odcs/bulk', [FoKabelCoreOdcController::class, 'bulk']);

    Route::get('/fo-odps', [FoOdpController::class, 'index']);
    Route::post('/fo-odps', [FoOdpController::class, 'store']);
    Route::get('/fo-odps/{id}', [FoOdpController::class, 'show']);
    Route::put('/fo-odps/{id}', [FoOdpController::class, 'update']);
    Route::patch('/fo-odps/{id}', [FoOdpController::class, 'update']);
    Route::delete('/fo-odps/{id}', [FoOdpController::class, 'destroy']);
    Route::patch('/fo-odps/{id}/archive', [FoOdpController::class, 'archive']);
    Route::patch('/fo-odps/{id}/unarchive', [FoOdpController::class, 'unarchive']);
    Route::patch('/fo-odps/{id}/restore', [FoOdpController::class, 'restore']);
    Route::post('/fo-odps/bulk', [FoOdpController::class, 'bulk']);

    Route::get('/fo-client-ftths', [FoClientFtthController::class, 'index']);
    Route::post('/fo-client-ftths', [FoClientFtthController::class, 'store']);
    Route::get('/fo-client-ftths/{id}', [FoClientFtthController::class, 'show']);
    Route::put('/fo-client-ftths/{id}', [FoClientFtthController::class, 'update']);
    Route::patch('/fo-client-ftths/{id}', [FoClientFtthController::class, 'update']);
    Route::delete('/fo-client-ftths/{id}', [FoClientFtthController::class, 'destroy']);
    Route::patch('/fo-client-ftths/{id}/archive', [FoClientFtthController::class, 'archive']);
